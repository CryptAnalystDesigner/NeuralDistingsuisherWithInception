...
def test(device,n=10, pairs=8,nr=13, num_structures=2**11, it=2**12, cutoff1=8, cutoff2=-600, neutral_bits=[[22],[14,21],[6,29],[30],[0,8,31],[5,28],[15,24],[4,27,29]], net=net8, net_help=net7, m_main=m8, s_main=s8,  m_help=m7, s_help=s7):
