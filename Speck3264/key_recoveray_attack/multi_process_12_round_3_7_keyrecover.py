...
def test(device,n=5, pairs=8,nr=12, num_structures=2**12, it=2**13, cutoff1=7, cutoff2=10, neutral_bits=[[12,19],[14,21],[6,29],[30],[0,8,31],[5,28]], keyschedule='real', net=net7, net_help=net6, m_main=m7, s_main=s7,  m_help=m6, s_help=s6, verify_breadth=None):
    ...
    for i in range(n):
        ...
        pt0,pt1,_,_ = make_structure(pt0,pt1,neutral_bits=[[22],[20],[13]])
...
if __name__ == "__main__":
    ...
    neutral_bits = [[22],[20],[14,21],[6,29],[0,8,31],[30]]
