...
def bayesian_key_recovery(pairs,cts, net=net11, m=m11, s=s11, num_cand=32, num_iter=5, seed=None):
...
def replace_1bit(a,b,i):
    ...
    a = a | (b << i)
    return a 
def test(device,n=20, pairs=8,nr=16, num_structures=2**8, it=2**9, cutoff1=90, cutoff2=100, neutral_bits=[[6],[8],[9],[10],[18],[22],[0,24]], net=net11, net_help=net10, m_main=m11, s_main=s11,  m_help=m10, s_help=s10, verify_breadth=None):
# def test(device,n=3, pairs=8,nr=16, num_structures=2**8, it=2**7, cutoff1=200, cutoff2=150, neutral_bits=[[6],[8],[9],[10],[18],[22],[0,24],[12,26]], net=net11, net_help=net10, m_main=m11, s_main=s11,  m_help=m10, s_help=s10, verify_breadth=None):
