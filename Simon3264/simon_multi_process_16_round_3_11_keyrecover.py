...
def test(device,n=5, pairs=8,nr=16, num_structures=2**8, it=2**9, cutoff1=37, cutoff2=70, neutral_bits=[[6],[8],[9],[10],[18],[22],[0,24],[12,26]], net=net11, net_help=net10, m_main=m11, s_main=s11,  m_help=m10, s_help=s10, verify_breadth=None):
    ...
    net = load_model(model_wdir+"simon_model_"+str(nr-5)+"r_depth5_num_epochs20_pairs"+str(pairs)+".h5")
    net_help = load_model(model_wdir+"simon_model_"+str(nr-5-1)+"r_depth5_num_epochs20_pairs"+str(pairs)+".h5")
